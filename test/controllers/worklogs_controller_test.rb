...
class WorklogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create worklog" do
    assert_difference('Worklog.count') do
      post worklogs_url, params: { worklog: { date: @worklog.date, hours: @worklog.hours, notes: @worklog.notes, user_id: @worklog.user_id } }
    end
  ...
  test "should update worklog" do
    patch worklog_url(@worklog), params: { worklog: { date: @worklog.date, hours: @worklog.hours, notes: @worklog.notes, user_id: @worklog.user_id } }
